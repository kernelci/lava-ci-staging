...
ROOTFS_URL = 'http://storage.kernelci.org/images/rootfs/debian/stretch/20180627.0'
INITRD_URL = '/'.join([ROOTFS_URL, '{}', 'initrd.cpio.gz'])
NFSROOTFS_URL = '/'.join([ROOTFS_URL, '{}', 'full.rootfs.tar.xz'])
