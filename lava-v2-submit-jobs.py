...
if __name__ == '__main__':
    ...
    parser.add_argument("--username", help="username for the LAVA server", required=True)
    parser.add_argument("--token", help="token for LAVA server api", required=True)
    parser.add_argument("--server", help="server url for LAVA server", required=True)
